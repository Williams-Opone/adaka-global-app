...
export default function LeadDashboard() {
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/admin/leads`)
      ...
      .finally(() => setLoading(false)); // Turn off loading when fetch completes
  }, []);
    ...
    <div className="min-h-screen bg-[#F0F4EF] text-[#0D1821]">
      ...
      <main className="p-6 md:p-16 lg:p-24 pt-32">
        <div className="max-w-7xl mx-auto">
          ...
          {loading ? (
            <div className="p-20 text-center opacity-30 font-heading text-2xl uppercase animate-pulse">
              Loading Data...
            </div>
          ) : leads.length === 0 ? (
            <div className="p-20 text-center border-2 border-dashed border-[#0D1821]/10 rounded-lg">
              ...
              <p className="font-sans text-sm uppercase opacity-30 mt-2">
                New inquiries will appear here once submitted.
              </p>
            </div>
          ) : (
            <>
